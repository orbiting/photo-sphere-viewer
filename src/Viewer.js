...
.psv-button--active .psv-button-svg * {
  fill: rgba(255, 255, 255, 0.9);
}
.psv-button:hover .psv-button-svg * {
...
export default ({ options, height = 500 }) => {
  ...
  useEffect(() => {
    const viewer = new PhotoSphereViewer({
      ...
      lang: {
        ...
        stereo_notification: 'Klicken Sie auf eine beliebige Stelle, um die Stereoansicht zu verlassen.',
        please_rotate: ['Bitte drehen Sie Ihr Gerät', '(oder tippen, um fortzufahren)'],
        two_fingers: ['Mit zwei Fingern navigieren']
      },
      ...options
    })
  ...
  return <>
    <div style={{ height }} ref={viewerRef} />
